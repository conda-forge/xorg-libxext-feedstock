...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxext-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxext-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libxext
# for installing globally
pixi global install xorg-libxext
```
...
It is possible to list all of the versions of `xorg-libxext` available on your platform:
...
```
pixi search xorg-libxext --channel conda-forge
```
